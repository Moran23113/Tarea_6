...
class Coctel_4 extends StatefulWidget {
  const Coctel_4({super.key});

  @override
  State<Coctel_4> createState() => _Coctel_4State();
}

class _Coctel_4State extends State<Coctel_4> {
  late Future<Cocteles> futureCocteles;
  @override
  void initState() {
    super.initState();
    futureCocteles = fetchCocteles(13072);
  }
                          ...
                          Column(
                            children: [
                              ...
                              SizedBox(
                                width: 100,
                                child: Image.network(
                                    'https://www.thecocktaildb.com/images/ingredients/Cherry%20liqueur-Medium.png'),
                              ),
                              Text(
                                  style: TextStyle(
                                    color: Colors.grey[300],
