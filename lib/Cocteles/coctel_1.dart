...
class Coctel_1 extends StatefulWidget {
  const Coctel_1({super.key});

  @override
  State<Coctel_1> createState() => _Coctel_1State();
}

class _Coctel_1State extends State<Coctel_1> {
  late Future<Cocteles> futureCocteles;
  @override
  void initState() {
    super.initState();
    futureCocteles = fetchCocteles(11118);
  }
